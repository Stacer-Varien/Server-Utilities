        ...
        if ctx.permissions.kick_members is True:
            ...
            if member == ctx.user:
                ...
                try:
                    ...
                    embed.add_field(name="Reason for warn (Channel were it was deleted and reason of delete)",
                                    value=reason.content, inline=False)
                    embed.add_field(
