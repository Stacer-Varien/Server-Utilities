...
no_invites = [925790260263256183, 925790260263256184, 949658438424735774, 949658438785458186, 925790260695281695,
              925790260695281696, 930029339137933332, 930029354052894740,
              930029368972042261, 930029393156386836, 930029405529575434, 930029415465877545, 925790261727068247,
              925790262104580096, 925790262104580097, 949740376443453460]
        ...
        if 'discord.gg' in message.content:
            if message.channel.id in no_invites:
                if not message.author.bot:
                    ...
                    if warn_point == 3:
                        await message.author.edit(timeout=utcnow() + timedelta(hours=2),
