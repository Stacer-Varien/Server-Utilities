...
class slashinfo(Cog):
    ...
    async def stats(self, ctx: Interaction):
        ...
        embed.set_footer(text="I am the legacy version of the cousin bot, HazeBot developed by {}. If you wish to have a bot made by him, please DM him. By the way, its not for free...".format(botowner))
