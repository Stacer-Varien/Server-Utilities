...
from nextcord.ext.application_checks import ApplicationNSFWChannelRequired, ApplicationMissingPermissions, \
    ApplicationNotOwner, ApplicationBotMissingPermissions
